...
/*
number % divisor === 0 determines whether the result of the division is an integer, making it a valid factor (given that a factor is a number that can be derived cleanly without decimal points from a division).
*/
